 ...
 */
final class Version20221228163208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_status DROP status');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD status VARCHAR(255) DEFAULT NULL, DROP status_id');
        $this->addSql('ALTER TABLE order_status ADD status VARCHAR(255) NOT NULL');
    }
}
